...
\textbf{Provisional arXiv subjects:} math.HO; math.LO (secondary: cs.LO;
q-bio.NC)
...
\subsubsection{5.1 Paper 1 (five
constants)}\label{paper-1-five-constants}
...
\subsubsection{5.2 Paper 2 (TVPCI supply-chain
transparency)}\label{paper-2-tvpci-supply-chain-transparency}
...
\subsubsection{5.4 Paper 5 (twistor
connection)}\label{paper-5-twistor-connection}
