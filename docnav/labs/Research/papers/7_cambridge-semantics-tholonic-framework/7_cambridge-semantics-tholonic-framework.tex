...
\title{Engineering Toward $N$: Cambridge Semantics as Empirical Validation\\
{\large of the Tholonic N-D-C Framework}}
...
\noindent\textbf{Provisional arXiv subjects:} cs.AI; cs.DB (secondary: cs.LO; math.HO)
