...
\date{\small 10 April 2026 \\ v1.0}

\begin{document}
\maketitle

\noindent\textbf{Keywords:} tholonic model, N-D-C triad, atomic structure, electron, field ontology, quark charges, virial theorem, Tesla, Einstein, quantum field theory, unified field theory, Koide formula, fine structure constant, fermion generations, falsifiability
