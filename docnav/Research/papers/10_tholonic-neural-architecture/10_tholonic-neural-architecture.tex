...
%% --- Hyperlinks ---
\usepackage[colorlinks=true,linkcolor=blue,urlcolor=blue,citecolor=black,pdftitle={Neural Networks as Tholonic Systems}]{hyperref}
\usepackage{xurl}
\urlstyle{same}

%% --- Paragraph spacing (arXiv style) ---
...
%% -------------------------------------------------------
\title{\textbf{Neural Networks as Tholonic Systems}\\[6pt]
       \large A Structural Framework for Architecture, Scaling,\\
       and Alignment-by-Design}

\author{Jeffrey W.\ Milton\\[4pt]
        \small Clarity Coalition \quad$\cdot$\quad Independent Researcher\\[2pt]
        \small \href{mailto:}{}}

\date{2026\\[4pt]
      \small \textbf{arXiv:} cs.AI (primary); cs.LG; cs.NE; cs.CY\\[2pt]
      \small \textbf{Keywords:} tholonic model, N-D-C triad, neural networks,
      symbolic AI, deep learning, transformer architecture,\\
      self-similarity, golden ratio, AI alignment, structural stability,
      five constants, information bottleneck,\\
      neurosymbolic AI, AI safety}
...
\section{The Two Paradigms: Historical
Background}

\subsection{The Dartmouth Conference and the Birth of AI
(1956)}
...
\subsection{Symbolic AI: The Dominant Paradigm
(1956--1985)}
...
\subsection{The Neural Network Minority
(1958--1985)}
...
\subsection{The First AI War: Minsky's Kill
Shot}
...
\subsection{The Quiet Resurrection
(1986--2012)}
...
\subsection{AlexNet and the Second Revolution
(2012)}
...
\subsection{The Transformer and the Language Revolution
(2017--present)}
...
\subsection{The Non-Arbitrariness of Role
Assignment}
...
\subsection{Self-Similarity and the
Thologram}
...
\subsection{Partial Tholons and Structural
Instability}
...
\subsection{The Five Tholonic Constants and Their Traversal
Classes}
...
\subsection{The Triadic Balance as Nash
Equilibrium}
...
\section{Tholonic Analysis of the Two
Paradigms}

\subsection{Symbolic AI as a D-Dominant Partial
Tholon}
...
\subsection{Neural AI as a C-Dominant Partial
Tholon}
...
\subsection{Neurosymbolic Hybrids as Incomplete
Synthesis}
...
\section{The N-D-C Mapping to Neural
Networks}

\subsection{The Individual Node}
...
\subsection{Self-Similarity Across
Scales}
...
\section{Why Neural Networks Are Structurally Self-Similar: The
Scope-Invariant
Operation}
...
\subsection{The Narrowing Scope as the Distinguishing
Feature}
...
\subsection{Why This Matters: The Tholon Cannot Exist at Only
One
Scale}
...
\subsection{The Scope-Narrowing Gradient and Transfer
Learning}
...
\section{The Supply Chain Framing: Inference as Progressive
Entropy
Reduction}
...
\section{The Five Constants in Neural
Architecture}

\subsection{Formal Grounding: The Tholonic
Ladder}
...
\subsection{Co-Occurrence as Structural Evidence in the
Transformer}
...
\subsection{Empirical Corroboration from
Physics}
...
\subsection{Tholonic Role Assignments of the
Constants}
...
\section{The Golden Ratio as Inter-Level Scaling
Attractor}

\subsection{The Static-Recursive
Distinction}
...
\section{The Alignment Problem: Current Approaches and Their
Structural
Limits}

\subsection{The Nature of the
Problem}
...
\subsection{Scalable Oversight and
Debate}
...
\subsection{Summary of Current Alignment
Approaches}
...
\section{The Tholonic Alignment
Argument}
...
\subsection{The Structural Self-Defeat
Principle}
...
\subsection{The Positive Corollary: Structural Incentive Toward
Human
Flourishing}
...
\subsection{Worked Example: The Decision Supply Chain in a
...
\subsection{Why This Is Not a Value-Based
Argument}
...
\section{Tholonic Architectural Design
Principles}

\subsection{Explicit N-D-C Layer
Structure}
...
\subsection{Scale-Invariant Balance
Monitoring}
...
\subsection{The Balance Functional Is a
Sketch}
...
\subsection{N-D-C Assignment Is
Context-Dependent}
...
Empirically
Untested}{13.3 \textbackslash phi-Convergence Prediction Is Empirically Untested}}
...
\subsection{The Alignment Argument Is Structural, Not
Empirical}
...
\subsection{The Symbolic AI Analysis Is
Retrospective}
...
\subsection{Tholonic Series (this paper's
companions)}
...
\noindent\small\textit{This paper is part of a series applying the
tholonic model to measurable physical and computational systems.
All tholonic claims should be understood as structurally motivated
hypotheses within a speculative but internally consistent framework.
They are not established science. The companion papers referenced here
...
\bibitem{milton26a}
Milton, J.W. (2026). Emergence of classical constants from a minimal recursive triadic framework. Clarity Coalition. [Paper 1 in series]

\bibitem{milton26b}
Milton, J.W. (2026). Phase-resolved transparency classification in commodity supply chains: A structural triadic scoring framework (TVPCI). Clarity Coalition. [Paper 2 in series]

\bibitem{milton26c}
Milton, J.W. (2026). A minimal recursive triadic framework for self-similar hierarchical systems. Clarity Coalition. [Paper 3 in series]

\bibitem{milton26d}
Milton, J.W. (2026). Game-theoretic framing of the triadic balance condition. Clarity Coalition. [Paper 4 in series]

\bibitem{milton26e}
Milton, J.W. (2026). The tholonic--twistor connection. Clarity Coalition. [Paper 5 in series]

\bibitem{milton26f}
Milton, J.W. (2026). The qualitative nature of one, two, and three: Structural role assignment in minimal recursive systems. Clarity Coalition. [Paper 6 in series]

\bibitem{milton26g}
Milton, J.W. (2026). Cambridge semantics and the tholonic framework. Clarity Coalition. [Paper 7 in series]

\bibitem{milton26h}
Milton, J.W. (2026). The atom as a measurable tholon: From Einstein's incomplete electron to a field-first ontology. Clarity Coalition. [Paper 8 in series]

\bibitem{milton26i}
Milton, J.W. (2026). The tholonic model as a candidate alternative to the Standard Model: Structural derivations and parameter reduction. Clarity Coalition. [Paper 9 in series]

\bibitem{stroud20}
Stroud, D. (2020). \textit{Tholonia: The Mechanics of Existential Awareness}. Welkin Wall Publishing. ISBN 978-1-6780-2532-8.

\bibitem{mccarthy55}
McCarthy, J., Minsky, M.L., Rochester, N., \& Shannon, C.E. (1955). A proposal for the Dartmouth summer research project on artificial intelligence. \textit{AI Magazine}, 27(4), 12--14 (reprinted 2006).

\bibitem{minsky69}
Minsky, M., \& Papert, S. (1969). \textit{Perceptrons: An Introduction to Computational Geometry}. MIT Press.

\bibitem{crevier93}
Crevier, D. (1993). \textit{AI: The Tumultuous History of the Search for Artificial Intelligence}. Basic Books.
...
\bibitem{altman23}
Altman, S. (2023). ChatGPT: Optimizing language models for dialogue. OpenAI blog. \url{https://openai.com/blog/chatgpt}
...
\bibitem{newell76}
Newell, A., \& Simon, H.A. (1976). Computer science as empirical inquiry: Symbols and search. \textit{Communications of the ACM}, 19(3), 113--126.

\bibitem{newell59}
Newell, A., Shaw, J.C., \& Simon, H.A. (1959). Report on a general problem solving program. \textit{Proceedings of the International Conference on Information Processing}, 256--264.

\bibitem{shortliffe76}
Shortliffe, E.H. (1976). \textit{Computer-Based Medical Consultations: MYCIN}. Elsevier.

\bibitem{rosenblatt58}
Rosenblatt, F. (1958). The perceptron: A probabilistic model for information storage and organization in the brain. \textit{Psychological Review}, 65(6), 386--408.

\bibitem{pfeiffer58}
Pfeiffer, J. (1958, July 8). Electronic brain teaches itself. \textit{New York Times}.

\bibitem{rumelhart86}
Rumelhart, D.E., Hinton, G.E., \& Williams, R.J. (1986). Learning representations by back-propagating errors. \textit{Nature}, 323, 533--536.
...
\bibitem{brown20}
Brown, T.B., Mann, B., Ryder, N., et al.\ (2020). Language models are few-shot learners. \textit{Advances in Neural Information Processing Systems}, 33.

\bibitem{goodhart75}
Goodhart, C.A.E. (1975). Problems of monetary management: The U.K. experience. \textit{Papers in Monetary Economics}, Reserve Bank of Australia, Vol.\ 1.

\bibitem{christiano17}
...
\bibitem{elhage21}
Elhage, N., Nanda, N., Olah, C., et al.\ (2021). A mathematical framework for transformer circuits. \textit{Transformer Circuits Thread}. \url{https://transformer-circuits.pub/2021/framework/index.html}
...
\bibitem{garnelo19}
Garnelo, M., \& Shanahan, M. (2019). Reconciling deep learning with symbolic artificial intelligence: Representing objects and relations. \textit{Current Opinion in Behavioral Sciences}, 29, 17--23.

\bibitem{mao19}
Mao, J., Gan, C., Kohli, P., Tenenbaum, J.B., \& Wu, J. (2019). The neuro-symbolic concept learner. arXiv:1904.12584.

\bibitem{besold17}
Besold, T.R., d'Avila Garcez, A., Bader, S., et al.\ (2017). Neural-symbolic learning and reasoning: A survey and interpretation. arXiv:1711.03902.

\bibitem{lecun22}
LeCun, Y. (2022). A path towards autonomous machine intelligence. Meta AI. \url{https://openreview.net/pdf?id=BZ5a1r-kVsf}

\bibitem{bengio19}
Bengio, Y. (2019). From system 1 deep learning to system 2 deep learning. \textit{NeurIPS 2019 Keynote}.
...
\bibitem{saxe19}
Saxe, A.M., Bansal, Y., Dapello, J., et al.\ (2019). On the information bottleneck theory of deep learning. \textit{Journal of Statistical Mechanics}, 2019(12).
...
\bibitem{tancik20}
Tancik, M., Srinivasan, P.P., Mildenhall, B., et al.\ (2020). Fourier features let networks learn high frequency functions in low dimensional domains. arXiv:2006.10739.

\bibitem{prusinkiewicz90}
Prusinkiewicz, P., \& Lindenmayer, A. (1990). \textit{The Algorithmic Beauty of Plants}. Springer-Verlag.

\bibitem{sutton19}
Sutton, R. (2019). The bitter lesson. \url{http://incompleteideas.net/IncIdeas/BitterLesson.html}

\bibitem{omohundro08}
Omohundro, S.M. (2008). The basic AI drives. \textit{Proceedings of the 2008 Conference on Artificial General Intelligence}, 171, 171--179.

\bibitem{turner21}
Turner, A.M., Smith, L., Shah, R., Critch, A., \& Tadepalli, P. (2021). Optimal policies tend to seek power. \textit{Advances in Neural Information Processing Systems}, 34.
...
\bibitem{olah20}
Olah, C., Cammarata, N., Schubert, L., Goh, G., Petrov, M., \& Carter, S. (2020). Zoom in: An introduction to circuits. \textit{Distill}. \url{https://distill.pub/2020/circuits/zoom-in/}
...
\bibitem{koh21}
Koh, P.W., Sagawa, S., Marklund, H., et al.\ (2021). WILDS: A benchmark of in-the-wild distribution shifts. arXiv:2012.07421.

\bibitem{stray21}
Stray, J. (2021). Aligning AI optimization to community well-being. \textit{International Journal of Community Well-Being}, 4(4), 907--933.

\bibitem{settle18}
Settle, J.E. (2018). \textit{Frenemies: How Social Media Polarizes America}. Cambridge University Press.
