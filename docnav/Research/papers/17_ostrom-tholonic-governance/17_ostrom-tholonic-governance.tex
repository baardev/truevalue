...
\title{Elinor Ostrom's Design Principles and the Tholonic N-D-C Framework:\\
\large Governance as Structural Balance}
...
\noindent\textbf{Keywords:} Elinor Ostrom; common-pool resources; design principles; tholonic model; N-D-C framework; tragedy of the commons; polycentric governance; institutional analysis; sustainability; governance balance score
...
\section{Ostrom's Framework: Common-Pool Resources and the Design Principles}\label{ostroms-framework-common-pool-resources-and-the-design-principles}

\subsection{The Common-Pool Resource Problem}\label{the-common-pool-resource-problem}
...
\subsection{The Eight Design Principles}\label{the-eight-design-principles}
...
\subsection{The Evidential Weight of These Principles}\label{the-evidential-weight-of-these-principles}
...
\subsection{Polycentric Governance}\label{polycentric-governance}
...
series {[}Mil26a, Mil26b, Mil26c{]}. The minimal recap required here is
as follows.
...
\section{Mapping Ostrom onto the Tholonic Framework}\label{mapping-ostrom-onto-the-tholonic-framework}

\subsection{The CPR System as a Tholon}\label{the-cpr-system-as-a-tholon}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[width=\linewidth,keepaspectratio]{figures/17_cpr-tholon-triangle.png}}
...
\subsection{D-Type and C-Type Principles}\label{d-type-and-c-type-principles}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[width=\linewidth,keepaspectratio]{figures/17_principles-classification.png}}
...
\subsection{The Tragedy of the Commons as C-Dominant Partial Tholon}\label{the-tragedy-of-the-commons-as-c-dominant-partial-tholon}
...
\subsection{The D-Dominant Failure Mode: Regulatory Brittleness}\label{the-d-dominant-failure-mode-regulatory-brittleness}
...
\section{Case Studies with B-Score Analysis}\label{case-studies-with-b-score-analysis}
...
\subsection{Törbel, Switzerland (Alpine Meadow, Documented Since 1483)}\label{tuxf6rbel-switzerland-alpine-meadow-documented-since-1483}
...
\subsection{Alanya, Turkey (Inshore Fishery, Self-Organized from the 1970s)}\label{alanya-turkey-inshore-fishery-self-organized-from-the-1970s}
...
\subsection{Open-Access Fishery (C-Dominant Failure)}\label{open-access-fishery-c-dominant-failure}
...
\subsection{Atlantic Groundfish Regulatory Failure (D-Dominant)}\label{atlantic-groundfish-regulatory-failure-d-dominant}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[width=\linewidth,keepaspectratio]{figures/17_bscore-cases.png}}
...
\subsection{From Binary Assessment to Continuous Score}\label{from-binary-assessment-to-continuous-score}
...
\subsection{Two Structurally Distinct Failure Modes}\label{two-structurally-distinct-failure-modes}
...
\subsection{Cross-Scale Propagation}\label{cross-scale-propagation}
...
\section{Connection to the TVPCI Supply Chain Framework}\label{connection-to-the-tvpci-supply-chain-framework}

The tholonic governance analysis developed here is structurally
continuous with the supply chain transparency work in papers 2 and 4 of
this series {[}Mil26b, Mil26d{]}.
...
The TVPCI transparency score {[}Mil26b{]} measures the visibility of the
custodial flow: how observable is the D-C interaction at each phase?
Phases with high TVPCI-D (well-documented regulatory frameworks) and low
TVPCI-C (poorly documented cooperative participation) are precisely
D-dominant partial tholons in the Ostrom sense: they are brittle to
regulatory change and resistant to adaptive pressure from downstream
actors. The Ostrom framework and the tholonic supply chain analysis
converge on the same diagnostic: governance health requires balance
between the constraining apparatus and the participatory apparatus at
every phase. The supply chain fails the same way a CPR fails, for the
...
{[}Mil26b{]} Milton, J. W. \emph{Supply Chain Transparency and the
TVPCI.} Clarity Coalition, paper 2, 2026.

{[}Mil26c{]} Milton, J. W. \emph{Minimal Recursive Triadic Framework.}
Clarity Coalition, paper 3, 2026.

{[}Mil26d{]} Milton, J. W. \emph{Game-Theoretic Triadic Balance.}
Clarity Coalition, paper 4, 2026.

{[}Mil26e{]} Milton, J. W. \emph{Tholonic N-D-C Structure and Its
Philosophical Predecessors: Spinoza and Leibniz.} Clarity Coalition,
paper 16, 2026.
