...
\section{Dual Entropy Gradients and the Tholonic Void-Plenum
Equivalence}\label{dual-entropy-gradients-and-the-tholonic-void-plenum-equivalence}
...
\textbf{Keywords:} entropy; dual entropy; tholonic model; N-D-C
framework; conceptual entropy; material entropy; void-plenum
equivalence; animate matter; active principles; information theory;
cosmology; self-organization
...
The Tholonic N-D-C framework {[}Mil24c{]} provides a structural answer.
The framework assigns three irreducible functional roles to any
self-organizing recursive system: N (Negotiation: the emergent stable
state), D (Definition/Limitation: the constraining, organizing,
specifying role), and C (Contribution/Integration: the expansive,
accumulating, dispersive role). At the cosmic scale, the material domain
exhibits the properties of the C role: it disperses, expands, and
differentiates away from an initial concentration. The conceptual domain
exhibits the properties of the D role: it constrains, organizes, and
becomes more specifically structured over time. The dual entropy
gradients are therefore not an independent observation but a consequence
of role assignment.
...
Sidis's animate/inanimate distinction {[}Sid25{]} are treated in Paper
12 {[}Mil26a{]}. The present paper takes the structural argument further
and examines its cosmological implications independently.
...
\subsection{2. The N-D-C Role Assignment at the Cosmic
Scale}\label{the-n-d-c-role-assignment-at-the-cosmic-scale}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/13_tholonic-triad-cosmic.png}}
...
\subsection{3. Material Entropy Increase as C
Expansion}\label{material-entropy-increase-as-c-expansion}
...
\subsection{4. Conceptual Entropy Decrease as D
Organization}\label{conceptual-entropy-decrease-as-d-organization}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/13_dual-entropy-trajectories.png}}
...
\subsection{5. Newton's Active Principles and Sidis's Animate
Matter}\label{newtons-active-principles-and-sidiss-animate-matter}
...
conditions of Paper 3 {[}Mil24c{]}, N must emerge at some balance point.
Animate matter is the material trace of that emergence: the N state made
locally visible in the C domain.
...
\subsection{6. The Void-Plenum
Equivalence}\label{the-void-plenum-equivalence}
...
\subsection{7. Mathematical Grounding}\label{mathematical-grounding}
...
\subsubsection{7.1 Kuiper's Theorem}\label{kuipers-theorem}
...
\subsubsection{7.2 Shannon Entropy at
Extremes}\label{shannon-entropy-at-extremes}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/13_shannon-void-plenum.png}}
...
\subsubsection{7.3 Projective
Self-Duality}\label{projective-self-duality}
...
\subsection{8. Tholonic Predictions}\label{tholonic-predictions}
...
manuscript analysis (Paper 12 {[}Mil26a{]}, Appendix B).}
...
minimality conditions of Paper 3 {[}Mil24c{]}. Are these equivalent
claims? If yes, the tholonic framework provides a structural proof of
what Sidis could only argue statistically, and the dual entropy
gradients follow as a corollary.
...
{[}Mil24c{]} Milton, J. W. ``A Minimal Recursive Triadic Framework for
Self-Similar Hierarchical Systems.'' Clarity Coalition Working Paper,
2024.

{[}Mil26a{]} Milton, J. W. ``Newton's Framework Through the Tholonic
Lens: Alchemy, Physics, and the Triadic Structure of Nature.'' Clarity
Coalition Working Paper, 2026. (Paper 12 in this series.)
