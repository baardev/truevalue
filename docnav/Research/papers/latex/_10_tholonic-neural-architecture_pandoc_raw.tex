...
\subsubsection{1.1 Natural Evolution and Cooperative
Stability}\label{natural-evolution-and-cooperative-stability}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/10_paradigm-plane.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/10_ndc-neural-mapping.png}}
...
\subsubsection{5.6 Why Neural Networks Are Structurally Self-Similar:
The Scope-Invariant
Operation}\label{why-neural-networks-are-structurally-self-similar-the-scope-invariant-operation}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/10_entropy-funnel.png}}
...
\subsubsection{7.5 Emergent vs.~Engineered Instantiation: A Critical
Distinction}\label{emergent-vs.-engineered-instantiation-a-critical-distinction}
...
\subsubsection{7.6 Archetypal D and C Properties in Transformer
Architecture}\label{archetypal-d-and-c-properties-in-transformer-architecture}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/10_transformer-annotated.png}}
...
\subsubsection{8.4 Empirical Scaling Laws and Phase-Boundary
Measurements}\label{empirical-scaling-laws-and-phase-boundary-measurements}
...
\subsubsection{10.2 Relation to Existing Structural
Accounts}\label{relation-to-existing-structural-accounts}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/10_decision-pathways.png}}
...
\subsubsection{10.8 Open Problem: The Boundary of the
D-Context}\label{open-problem-the-boundary-of-the-d-context}
...
\subsubsection{13.3 Preliminary Empirical
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/10_phase-detection-traces.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/10_pass-rates-by-model.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/10_constant-roles.png}}
...
\subsubsection{13.4 Structural Health Grading: Five-Axis Assessment
Across 20
Models}\label{structural-health-grading-five-axis-assessment-across-20-models}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/10_health-heatmap.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/10_virial-gap.png}}
...
\subsubsection{13.5 The Alignment Argument Is Structural, Not
...
\subsubsection{13.6 The Symbolic AI Analysis Is
