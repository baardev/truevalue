...
\section{Cancer as Progressive D-Collapse: A Tholonic Framework for
Oncogenesis, Malignancy Grading, and Therapeutic
Resistance}\label{cancer-as-progressive-d-collapse-a-tholonic-framework-for-oncogenesis-malignancy-grading-and-therapeutic-resistance}

\textbf{Author:} J. W. Milton, Clarity Coalition

\textbf{Version:} 1.0

\textbf{Date:} 14 June 2026

\textbf{Keywords:} tholonic model; oncogenesis; tumor suppressor;
D-collapse; balance score; malignancy grading; therapeutic resistance;
hallmarks of cancer; N-D-C framework; quantitative oncology
...
The tholonic N-D-C framework, introduced in paper 3 of this series
{[}Mil26c{]} and grounded mathematically in paper 1 {[}Mil26a{]},
...
The tholonic model, developed in papers 1 through 3 of this series
{[}Mil26a, Mil26b, Mil26c{]}, holds that any self-sustaining system can
be analyzed in terms of three structurally distinct roles.
...
structure of the framework (paper 2, {[}Mil26b{]}) and are not fitted to
the oncology data.
...
\subsection{3. N-D-C Mapping for Normal Cell
Biology}\label{n-d-c-mapping-for-normal-cell-biology}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/14_ndc-cancer-triangle.png}}
...
\subsection{4. Oncogenesis as Progressive
D-Collapse}\label{oncogenesis-as-progressive-d-collapse}

\subsubsection{4.1 Driver Mutations as D-Primitive Loss
Events}\label{driver-mutations-as-d-primitive-loss-events}
...
\subsubsection{4.2 The Hanahan-Weinberg Hallmarks as a D-Collapse
Sequence}\label{the-hanahan-weinberg-hallmarks-as-a-d-collapse-sequence}
...
\subsubsection{4.3 Metastasis as Complete C-D
Uncoupling}\label{metastasis-as-complete-c-d-uncoupling}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/14_d-collapse-trajectory.png}}
...
\subsection{5. Quantitative Proxies for D and
C}\label{quantitative-proxies-for-d-and-c}

\subsubsection{5.1 The Tumor Suppressor Gene Integrity Score
(TSGI)}\label{the-tumor-suppressor-gene-integrity-score-tsgi}
...
\subsubsection{5.2 The Proliferative Index as
C-Proxy}\label{the-proliferative-index-as-c-proxy}
...
\subsubsection{5.3 Computing the B-Score}\label{computing-the-b-score}
...
\subsubsection{5.4 Worked Example: Colorectal
Adenocarcinoma}\label{worked-example-colorectal-adenocarcinoma}
...
\subsection{6. Predicted Correspondence with WHO Malignancy
Grades}\label{predicted-correspondence-with-who-malignancy-grades}
...
definitions. They are the same thresholds used in paper 2 {[}Mil26b{]}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/14_grade-bscore-chart.png}}
...
\subsection{7. Drug Resistance as C-Adaptation to Imposed
D}\label{drug-resistance-as-c-adaptation-to-imposed-d}

\subsubsection{7.1 Chemotherapy and Targeted Therapy as External D
Constraints}\label{chemotherapy-and-targeted-therapy-as-external-d-constraints}
...
\subsubsection{7.2 Resistance Mechanisms as
C-Routing}\label{resistance-mechanisms-as-c-routing}
...
\subsubsection{7.3 Immunotherapy as
D-Restoration}\label{immunotherapy-as-d-restoration}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/14_resistance-cycle.png}}
...
\subsubsection{9.1 Relationship to Existing Oncological
Frameworks}\label{relationship-to-existing-oncological-frameworks}
...
\subsubsection{9.2 The Role of Tumor
Heterogeneity}\label{the-role-of-tumor-heterogeneity}
