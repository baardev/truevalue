...
\textbf{CONFIDENTIAL AND PRIVATE. DO NOT DISTRIBUTE.}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Tholonic N-D-C Signal Architecture for Accumulation-Biased Grid
Trading: Design, Implementation, and 59-Day Empirical Results on
SOL/USD}\label{tholonic-n-d-c-signal-architecture-for-accumulation-biased-grid-trading-design-implementation-and-59-day-empirical-results-on-solusd}
...
\textbf{Keywords:} tholonic model; N-D-C framework; grid trading;
accumulation strategy; golden ratio; energy cost; imbalance signal;
SOL/USD; cryptocurrency; phi spacing

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsection{Results at a Glance}\label{results-at-a-glance}
...
\subsection{2. The Tholonic N-D-C Framework Applied to
Markets}\label{the-tholonic-n-d-c-framework-applied-to-markets}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{/home/jw/src/tv/docnav/Research/papers/20_tholonic-grid-trading-ndc/figures/20_ndc-market-triangle.png}}
...
\subsubsection{2.1 Why the Asset Is the Correct Unit of
Account}\label{why-the-asset-is-the-correct-unit-of-account}
...
\subsection{3. D and C Primitive
Definitions}\label{d-and-c-primitive-definitions}
...
\subsubsection{3.1 D Primitives: Bearish
Constraints}\label{d-primitives-bearish-constraints}
...
\subsubsection{3.2 C Primitives: Bullish
Contributions}\label{c-primitives-bullish-contributions}
...
\subsection{4. Imbalance and Energy: The Core Signal
Pair}\label{imbalance-and-energy-the-core-signal-pair}
...
\subsubsection{4.1 Imbalance}\label{imbalance}
...
\subsubsection{4.2 Energy Cost}\label{energy-cost}
...
\subsubsection{4.3 The N State}\label{the-n-state}
...
\subsubsection{4.4 Reading the Operational
Chart}\label{reading-the-operational-chart}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{/home/jw/src/tv/docnav/Research/papers/20_tholonic-grid-trading-ndc/figures/20_energy-imbalance-timeseries.png}}
...
\subsection{5. Grid Architecture: Phi-Spaced Level
Hierarchy}\label{grid-architecture-phi-spaced-level-hierarchy}

\subsubsection{5.1 The Base Quantum}\label{the-base-quantum}
...
\subsubsection{5.2 The Five Phi-Spaced
Levels}\label{the-five-phi-spaced-levels}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{/home/jw/src/tv/docnav/Research/papers/20_tholonic-grid-trading-ndc/figures/20_phi-grid-levels.png}}
...
\subsection{6. Operational Modes and Regime
Logic}\label{operational-modes-and-regime-logic}

\subsubsection{6.1 Hysteresis}\label{hysteresis}
...
\subsubsection{6.2 The Five Modes}\label{the-five-modes}
...
\subsection{7. Auxiliary Signals}\label{auxiliary-signals}

\subsubsection{7.1 Phi-Extension Signal}\label{phi-extension-signal}
...
\subsubsection{7.2 Lambda: Volume Recovery
Signal}\label{lambda-volume-recovery-signal}
...
\subsection{8. Empirical Results: 59-Day SOL/USD
Run}\label{empirical-results-59-day-solusd-run}
...
\subsubsection{8.2 Summary Statistics}\label{summary-statistics}
...
\subsubsection{8.3 Mode Distribution}\label{mode-distribution}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{/home/jw/src/tv/docnav/Research/papers/20_tholonic-grid-trading-ndc/figures/20_mode-distribution.png}}
...
\subsubsection{8.4 Accumulation Record}\label{accumulation-record}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{/home/jw/src/tv/docnav/Research/papers/20_tholonic-grid-trading-ndc/figures/20_accumulation-cash-equity.png}}
...
\subsubsection{9.1 Accumulation Objective
Assessment}\label{accumulation-objective-assessment}
...
\subsubsection{9.2 The Distribute-Mode Accumulation
Paradox}\label{the-distribute-mode-accumulation-paradox}
...
\subsubsection{9.3 Cash Exhaustion Risk}\label{cash-exhaustion-risk}
...
\subsubsection{9.4 Order Rejection Rate}\label{order-rejection-rate}
