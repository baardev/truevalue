...
\section{Tholonic N-D-C Structure and Its Philosophical Predecessors:
Spinoza and
Leibniz}\label{tholonic-n-d-c-structure-and-its-philosophical-predecessors-spinoza-and-leibniz}
...
\textbf{Keywords:} tholonic model; Spinoza; Leibniz; substance monism;
monadology; N-D-C framework; conatus; pre-established harmony;
philosophical predecessors; structural metaphysics; recursive triad
...
through
\href{https://github.com/baardev/truevalue/raw/main/docnav/Research/papers/15_consciousness-dmn-d-apparatus/15_consciousness-dmn-d-apparatus.pdf}{15}
...
\subsection{2. The Tholonic N-D-C
...
\subsubsection{2.1 Core Structure}\label{core-structure}
...
\subsubsection{2.2 Recursive
Self-Similarity}\label{recursive-self-similarity}
...
\subsubsection{2.3 Hierarchy}\label{hierarchy}
...
\subsubsection{2.4 The Partial Tholon and Structural
Failure}\label{the-partial-tholon-and-structural-failure}
...
\subsection{3. Spinoza's System: Key Structural
Features}\label{spinozas-system-key-structural-features}
...
\subsubsection{3.1 Substance, Attributes, and
Modes}\label{substance-attributes-and-modes}
...
\subsubsection{3.2 Natura Naturans and Natura
Naturata}\label{natura-naturans-and-natura-naturata}
...
\subsubsection{3.3 Conatus: Structural
Self-Preservation}\label{conatus-structural-self-preservation}
...
\subsubsection{3.4 Attribute Parallelism}\label{attribute-parallelism}
...
\subsection{4. Mapping Spinoza onto the Tholonic
Framework}\label{mapping-spinoza-onto-the-tholonic-framework}

\subsubsection{4.1 Substance as N}\label{substance-as-n}
...
\subsubsection{4.2 Natura Naturans and Natura Naturata as the N-D-C
Recursion}\label{natura-naturans-and-natura-naturata-as-the-n-d-c-recursion}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{/home/jw/src/tv/docnav/Research/papers/16_tholonic-spinoza-leibniz/figures/16_philosopher-ndc-triangles.png}}
\caption{Two-panel figure showing the Spinoza-tholon mapping and the
Leibniz-tholon mapping.}
\end{figure}

\subsubsection{4.3 Conatus as the N-State's Self-Maintenance
Principle}\label{conatus-as-the-n-states-self-maintenance-principle}
...
\subsubsection{4.4 Attribute Parallelism as D-C
Complementarity}\label{attribute-parallelism-as-d-c-complementarity}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{/home/jw/src/tv/docnav/Research/papers/16_tholonic-spinoza-leibniz/figures/16_concept-alignment-heatmap.png}}
...
\subsubsection{4.5 Where the Spinoza Mapping Breaks
Down}\label{where-the-spinoza-mapping-breaks-down}
...
\subsection{5. Leibniz's System: Key Structural
Features}\label{leibnizs-system-key-structural-features}
...
\subsubsection{5.1 Monads: Self-Contained
Units}\label{monads-self-contained-units}
...
\subsubsection{5.2 Hierarchy: Bare Monads, Souls, and Rational
Monads}\label{hierarchy-bare-monads-souls-and-rational-monads}
...
\subsubsection{5.3 Pre-Established
Harmony}\label{pre-established-harmony}
...
\subsubsection{5.4 Principles Governing the Monadic
System}\label{principles-governing-the-monadic-system}
...
\subsubsection{5.5 Mathematical Grounding}\label{mathematical-grounding}
...
\subsection{6. Mapping Leibniz onto the Tholonic
Framework}\label{mapping-leibniz-onto-the-tholonic-framework}

\subsubsection{6.1 Monads as Tholons}\label{monads-as-tholons}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{/home/jw/src/tv/docnav/Research/papers/16_tholonic-spinoza-leibniz/figures/16_monad-tholon-hierarchy.png}}
...
\subsubsection{6.2 Monad Hierarchy as Tholonic
Levels}\label{monad-hierarchy-as-tholonic-levels}
...
\subsubsection{6.3 Pre-Established Harmony as Structural
Balance}\label{pre-established-harmony-as-structural-balance}
...
\subsubsection{6.4 Windowlessness and Its Tholonic
Reinterpretation}\label{windowlessness-and-its-tholonic-reinterpretation}
...
\subsubsection{6.5 Entelechy, Activity, and the
N-State}\label{entelechy-activity-and-the-n-state}
...
\subsubsection{6.6 Mathematical Grounding and the Binary
Foundation}\label{mathematical-grounding-and-the-binary-foundation}
...
\subsection{7. Comparative Analysis: Which System Is More Structurally
Similar?}\label{comparative-analysis-which-system-is-more-structurally-similar}

\subsubsection{7.1 Points of Convergence}\label{points-of-convergence}
...
\subsubsection{7.2 Which Philosopher Offers the Closer Structural
Parallel}\label{which-philosopher-offers-the-closer-structural-parallel}
...
\subsubsection{7.3 Where Spinoza Is
Irreplaceable}\label{where-spinoza-is-irreplaceable}
...
\subsubsection{7.4 Complementarity}\label{complementarity}
...
\subsection{8. What the Tholonic Model
...
\href{https://github.com/baardev/truevalue/raw/main/docnav/Research/papers/9_tholonic-model-standard-model-alternative/9_tholonic-model-standard-model-alternative.pdf}{Mil26d}
...
\href{https://github.com/baardev/truevalue/raw/main/docnav/Research/papers/10_tholonic-neural-architecture/10_tholonic-neural-architecture.pdf}{Mil26e}
...
\href{https://github.com/baardev/truevalue/raw/main/docnav/Research/papers/12_newton-tholonic-framework/12_newton-tholonic-framework.pdf}{Mil26f}
...
\href{https://github.com/baardev/truevalue/raw/main/docnav/Research/papers/13_dual-entropy-tholonic-cosmology/13_dual-entropy-tholonic-cosmology.pdf}{Mil26g}
Milton, J. W. \emph{Dual Entropy Tholonic Cosmology.} Clarity Coalition,
\href{https://github.com/baardev/truevalue/raw/main/docnav/Research/papers/13_dual-entropy-tholonic-cosmology/13_dual-entropy-tholonic-cosmology.pdf}{paper
13}, 2026.

\href{https://github.com/baardev/truevalue/raw/main/docnav/Research/papers/14_cancer-d-collapse/14_cancer-d-collapse.pdf}{Mil26h}
Milton, J. W. \emph{Cancer and D-Collapse.} Clarity Coalition,
\href{https://github.com/baardev/truevalue/raw/main/docnav/Research/papers/14_cancer-d-collapse/14_cancer-d-collapse.pdf}{paper
14}, 2026.

\href{https://github.com/baardev/truevalue/raw/main/docnav/Research/papers/15_consciousness-dmn-d-apparatus/15_consciousness-dmn-d-apparatus.pdf}{Mil26i}
Milton, J. W. \emph{The Default Mode Network as D-Apparatus.} Clarity
Coalition,
\href{https://github.com/baardev/truevalue/raw/main/docnav/Research/papers/15_consciousness-dmn-d-apparatus/15_consciousness-dmn-d-apparatus.pdf}{paper
15}, 2026.
