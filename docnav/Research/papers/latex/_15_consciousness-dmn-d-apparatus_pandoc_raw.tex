...
\section{The Default Mode Network as D-Apparatus: A Tholonic Account of
Consciousness, Psychedelic States, and the Therapeutic
Window}\label{the-default-mode-network-as-d-apparatus-a-tholonic-account-of-consciousness-psychedelic-states-and-the-therapeutic-window}

\textbf{Author:} J. W. Milton, Clarity Coalition

\textbf{Version:} 1.0

\textbf{Date:} 15 June 2026

\textbf{Keywords:} tholonic model; default mode network; consciousness;
predictive coding; free energy principle; psychedelics; psilocybin; ego
dissolution; REBUS; therapeutic window; N-D-C framework; self-model
...
The tholonic N-D-C framework, introduced in papers 1 through 3 of this
series {[}Mil26a, Mil26b, Mil26c{]}, describes how any coherent system
maintains stability through the balance of a constraint apparatus (D)
and a productive apparatus (C), with the coherent state N emerging from
their approximate balance. This paper argues that the DMN, predictive
priors, and the REBUS model together describe a D-apparatus in precise
computational terms, and that the resulting tholonic mapping provides a
quantitative state-space for consciousness that spans both normal and
altered states.
...
The tholonic model, grounded mathematically in paper 1 {[}Mil26a{]} and
axiomatically in paper 3 {[}Mil26c{]}, holds that any coherent,
self-sustaining system exhibits three structurally distinct functional
roles.
...
boundary of structural instability, as established in paper 2
{[}Mil26b{]}.
...
\subsection{3. The DMN as D-Apparatus}\label{the-dmn-as-d-apparatus}

\subsubsection{3.1 What the Default Mode Network
Does}\label{what-the-default-mode-network-does}
...
\subsubsection{3.2 The DMN is Computationally
D}\label{the-dmn-is-computationally-d}
...
\subsubsection{3.3 Sensory Prediction Errors as
C}\label{sensory-prediction-errors-as-c}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/15_ndc-consciousness-triangle.png}}
...
\subsection{4. The REBUS Correspondence}\label{the-rebus-correspondence}
...
\subsection{5. Consciousness States in D/C
Space}\label{consciousness-states-in-dc-space}

\subsubsection{5.1 The State-Space
Representation}\label{the-state-space-representation}
...
\subsubsection{5.2 The Anesthesia Magnitude
Caveat}\label{the-anesthesia-magnitude-caveat}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/15_consciousness-state-map.png}}
...
\subsection{6. Psychedelic Mechanism and Ego
Dissolution}\label{psychedelic-mechanism-and-ego-dissolution}

\subsubsection{6.1 The Dose-Response
Relationship}\label{the-dose-response-relationship}
...
\subsubsection{6.2 Ego Dissolution as
N-Dissolution}\label{ego-dissolution-as-n-dissolution}
...
\subsubsection{6.3 Neural Entropy as
C-Runaway}\label{neural-entropy-as-c-runaway}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/15_dmn-therapeutic-window.png}}
...
\subsection{7. Maladaptive High-D States and the Therapeutic
Window}\label{maladaptive-high-d-states-and-the-therapeutic-window}

\subsubsection{7.1 Depression and PTSD as
D-Rigidity}\label{depression-and-ptsd-as-d-rigidity}
...
\subsubsection{7.2 The Therapeutic Window}\label{the-therapeutic-window}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/15_therapeutic-mechanism.png}}
...
\subsection{8. Psychosis as D-Dysregulation, Not
D-Collapse}\label{psychosis-as-d-dysregulation-not-d-collapse}
...
\subsection{9. Meditation as Voluntary
D-Modulation}\label{meditation-as-voluntary-d-modulation}
...
\subsection{10. Falsifiable Predictions}\label{falsifiable-predictions}
...
\subsubsection{11.1 Relation to Existing Computational
Frameworks}\label{relation-to-existing-computational-frameworks}
...
\subsection{12. Conclusions}\label{conclusions}
...
minimal recursive triadic framework. Clarity Coalition, 2026. (Paper 1
of this series.)

{[}Mil26b{]} Milton, J. W. Phase-resolved transparency classification of
the gold supply chain. Clarity Coalition, 2026. (Paper 2 of this
series.)

{[}Mil26c{]} Milton, J. W. A minimal recursive triadic framework for
self-similar hierarchical systems. Clarity Coalition, 2026. (Paper 3 of
this series.)
