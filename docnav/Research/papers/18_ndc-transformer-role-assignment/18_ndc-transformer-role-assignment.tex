...
\title{Transformer Architectures as Tholonic Instantiations:\\
\large A Formal Role Assignment and Structural Derivation}
\author{J. W. Milton\\[4pt]{\small Clarity Coalition}}
\date{\small 27 June 2026 \\ v1.0}

\begin{document}
\maketitle

\noindent\textbf{Keywords:} tholonic model, N-D-C triad, transformer architecture, role assignment, structural derivation, virial balance, five constants, golden ratio, phase boundaries, alignment, C-dominance, LayerNorm, attention, MLP

\begin{abstract}
The tholonic framework
(\href{https://github.com/baardev/truevalue/blob/main/docnav/Research/papers/1_recursive-tholonic-five-constants/1_recursive-tholonic-five-constants.pdf}{Papers
1} and
...
\subsection{The logical gap}\label{the-logical-gap}
...
\subsection{The TVPCI parallel}\label{the-tvpci-parallel}
...
\section{The N-D-C Framework}\label{the-n-d-c-framework}

\subsection{The tholonic triad}\label{the-tholonic-triad}
...
\subsection{The recursion and its fixed points}\label{the-recursion-and-its-fixed-points}
...
\subsection{Self-similar nesting}\label{self-similar-nesting}
...
\subsection{Two structural consequences used in this paper}\label{two-structural-consequences-used-in-this-paper}
...
\section{The Transformer Forward Pass as an N-D-C Recursion}\label{the-transformer-forward-pass-as-an-n-d-c-recursion}
...
\subsection{Functional independence of the three roles}\label{functional-independence-of-the-three-roles}
...
\subsection{Summary of the proof}\label{summary-of-the-proof}
...
\section{Component-Level Role Assignment}\label{component-level-role-assignment}
...
\subsection{Assignment uniqueness}\label{assignment-uniqueness}
...
\subsection{Assignment stability across architecture variants}\label{assignment-stability-across-architecture-variants}
...
\section{Structural Predictions Derived from the Role Assignment}\label{structural-predictions-derived-from-the-role-assignment}
...
\subsection{Phase boundaries at the five constants}\label{phase-boundaries-at-the-five-constants}
...
\subsection{Universal C-dominance}\label{universal-c-dominance}
...
\subsection{The virial balance regulariser}\label{the-virial-balance-regulariser}
...
\subsection{Optimal-depth prediction}\label{optimal-depth-prediction}
...
\section{Edge Cases: MoE Routing, Residuals, and Positional Encodings}\label{edge-cases-moe-routing-residuals-and-positional-encodings}

\subsection{Mixture-of-Experts routing}\label{mixture-of-experts-routing}
...
\subsection{Positional encodings}\label{positional-encodings}
...
\section{Falsifiability Criteria}\label{falsifiability-criteria}
...
\subsection{Implications for architecture design}\label{implications-for-architecture-design}
...
\subsection{Relationship to alignment}\label{relationship-to-alignment}
...
\url{https://github.com/baardev/truevalue/blob/main/docnav/Research/papers/2_supply-chain-transparency-tvpci/2_supply-chain-transparency-tvpci.pdf}
...
\url{https://github.com/baardev/truevalue/blob/main/docnav/Research/papers/10_tholonic-neural-architecture/10_tholonic-neural-architecture.pdf}
