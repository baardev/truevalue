...
key_claims:
  - physical_flow_precedes_value_interpretation
source_role: governance_rule
---
...
Value-chain rules live in `docs/Guidelines/VALUE_CHAIN_RULES.md`.
