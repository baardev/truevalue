---
doc_id: frontend_docs_research_modeling_sarah_data_ingestion_quick_reference
title: Sarah Document Quick Reference
type: research_note
status: active
...
|--------------------|--------------------|------|
| Physical flow first | Rule Set 1: Separation of Concerns | docs/Guidelines/SUPPLY_CHAIN_RULES.md |
...
| Sustainability index | NDC framework | docs/PDI/THOLONIC_INTEGRATION.md |
...
cat > docs/Reports/WATER_WASTE_METHODOLOGY.md
...
### New Files
- ✅ `docs/Activities/SARAH_INTEGRATION_ANALYSIS.md` (full analysis)
- ✅ `docs/Research/SARAH_DATA_INGESTION_QUICK_REFERENCE.md` (this file)
- ⏳ `schema/entity_registry.csv` (to create)
- ⏳ `docs/Reports/WATER_WASTE_METHODOLOGY.md` (to create)
...
- ⏳ `docs/api/FRONTEND_API.md` (add environmental endpoints)
