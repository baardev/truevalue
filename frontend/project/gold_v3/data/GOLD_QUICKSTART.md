...
fetch('/frontend/project/gold/data/processed/phases.json')
  .then(res => res.json())
  .then(data => {
...
fetch('/frontend/project/gold/data/processed/simulation_defaults.json')
  .then(res => res.json())
  .then(config => {
...
| Page | URL |
|------|-----|
| Gold supply chain (landing) | http://localhost:8000/frontend/project/gold/supply_chain/Supplychain.html |
| Gold dashboard | http://localhost:8000/frontend/project/gold/supply_chain/dashboard.html |
| Gold what-if simulator | http://localhost:8000/frontend/project/gold/supply_chain/what_if_simulator.html |
| **Shea supply chain (landing)** | http://localhost:8000/frontend/project/west_african_shea/index.html |
| Shea dashboard | http://localhost:8000/frontend/project/west_african_shea/supply_chain/dashboard.html |
| Shea what-if simulator | http://localhost:8000/frontend/project/west_african_shea/supply_chain/what_if_simulator.html |
| **Shea value chain (landing)** | http://localhost:8000/frontend/project/west_african_shea/value_chain/index.html |
| Shea value dashboard | http://localhost:8000/frontend/project/west_african_shea/value_chain/dashboard.html |
| Shea value what-if simulator | http://localhost:8000/frontend/project/west_african_shea/value_chain/what_if_simulator.html |
...
- Review `docs/Guidelines/SUPPLY_CHAIN_RULES.md` for methodology
- Review `docs/api/FRONTEND_API.md` for API spec
