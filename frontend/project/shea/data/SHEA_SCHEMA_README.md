...
| **EXTRACTED_SHEA_DATA_SUMMARY.md** | Summary of data extracted from Mirova, Acorn Onboarding, Serious Shea BPlan V8 PDFs (this folder). |
| **`v2/data/UNINTEGRATED_FILES_QUICK_VIEW.md`** | Quick view of unintegrated `v2/data` files that remain in the v2 working tree (e.g. Acorn 080523, Ep-Carbon) and suggested actions. |
