...
*Document ties to: `frontend/project/west_african_shea/data/` (shea CSVs, `Clarity_Cleo_Shea_Value_Chain_Outline.md`, `EXTRACTED_SHEA_DATA_SUMMARY.md`, and related Serious Shea source files). Remaining ad-hoc sources (e.g. Acorn 080523, Ep-Carbon) stay in `v2/data`.*
