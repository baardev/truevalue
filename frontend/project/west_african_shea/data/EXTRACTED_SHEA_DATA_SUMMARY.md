...
title: "Extracted Shea Data – Summary (lives in `frontend/project/west_african_shea/data/` with the shea schema CSVs and source PDFs/Office files)"
type: summary
status: active
...
# Extracted Shea Data – Summary (lives in `frontend/project/west_african_shea/data/` with the shea schema CSVs and source PDFs/Office files)
...
*Generated when integrating Mirova Feasibility, Clarity outline, Acorn Onboarding, and Serious Shea BPlan V8 into `frontend/project/west_african_shea/data/` shea CSVs (previously also under v2).*
