...
This document defines how water, waste, and energy metrics are measured, calculated, and attributed across the gold supply chain (Phases 0-8). These metrics were added to integrate Sarah's "TRUE VALUE METRICS" requirements (tv-sarah.txt, lines 46-62) while maintaining compliance with the project's 9 Rule Sets.
